...
# https://openreview.net/invitation/edit?id=cclear.cc/CLeaR/2023/Conference/-/Camera_Ready
# Needs to be modified based on the conference
CONFERENCE_NAME = 'CLeaR23'
CONFERENCE_INVITATION = 'cclear.cc/CLeaR/2023/Conference/-/Blind_Submission'
